<template>
  <section id="home" class="hero">
    <div class="hero__headings">
      ...
      <p>
        I am a Front-end Web Developer from Italy with a strong focus on responsive web design, accessibility, and performance.
        <br>
        I love to work with developers and designers to imagine and shape the future.
      </p>
      <p class="hero__social">
        ...
        <a rel="noopener noreferrer" target="_blank" href="https://medium.com/@marcellop" class="button">
          <svg width="25" height="19" viewBox="0 0 25 19" xmlns="http://www.w3.org/2000/svg"><path d="M3.56 14.373c0 .555-.027.687-.318 1.03L.785 18.388v.396H7.76v-.396l-2.457-2.985c-.29-.343-.344-.502-.344-1.03V5.42l6.126 13.364h.714L17.056 5.42v10.644c0 .29 0 .342-.185.528l-1.847 1.796v.396h9.19v-.396l-1.822-1.796c-.183-.186-.21-.238-.21-.528V2.937c0-.29.027-.344.21-.528L24.215.61V.216h-6.47L13.12 11.758 7.92.216h-6.79v.396l2.14 2.64c.24.292.29.37.29.768v10.353h.002z" fill-rule="nonzero"/></svg>
          <span>Medium</span>
        </a>
      </p>
    </div>
...
<!--        srcset="-->
<!--/assets/img/hero/marcello-hero_oesa3w_ar_1_1,c_fill,g_auto__c_scale,w_320.jpg 320w,-->
<!--/assets/img/hero/marcello-hero_oesa3w_ar_1_1,c_fill,g_auto__c_scale,w_654.jpg 654w,-->
<!--/assets/img/hero/marcello-hero_oesa3w_ar_1_1,c_fill,g_auto__c_scale,w_892.jpg 892w,-->
<!--/assets/img/hero/marcello-hero_oesa3w_ar_1_1,c_fill,g_auto__c_scale,w_1099.jpg 1099w">-->
<!--      <img class="lazyload blur-up"-->
<!--           sizes="(max-width: 2000px) 100vw, 2000px"-->
<!--           srcset="-->
<!--/assets/img/hero/marcello-hero_oesa3w_c_scale,w_768.jpg 768w,-->
