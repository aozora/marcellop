    ...
    <div class="row">
      <div class="small-12 medium-6 column">
        <div class="about-area__howdy">
          <h3>Howdy!</h3>
          <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by th charms of pleasure of the moment, so blinded by desire, tht they cannot foresee the pain and trouble that are</p>
      ...
      <div class="small-12 medium-6 column">
        <div class="about-area__progress">
          <!-- skill bar 1 -->
