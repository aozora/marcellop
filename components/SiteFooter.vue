<template>
  <footer class="footer">
    ...
    <p class="footer__copyright">&copy; 2010–2019 Copyright Marcello Palmitessa. All rights reserved.</p>
    <p class="footer__credits">This site is built with <a target="_blank" rel="noopener noreferrer" href="https://nuxtjs.org/">NuxtJs</a> and hosted on
      <a target="_blank" rel="noopener noreferrer" href="https://www.netlify.com/">Netlify</a>. The source code is hosted on
      <a target="_blank" rel="noopener noreferrer" href="https://github.com/aozora/marcellop">GitHub</a>.
    </p>
  </footer>
</template>
