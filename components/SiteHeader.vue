      ...
      <ul class="menu__social">
        ...
        <li>
          <a rel="noopener noreferrer" target="_blank" href="http://it.linkedin.com/in/marcellopalmitessa">
            <svg aria-hidden="true" width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M6.705 3.703c0 .96-.285 1.769-.854 2.427-.568.659-1.408.988-2.519.988-1.002 0-1.801-.33-2.397-.988C.339 5.472.027 4.731 0 3.91c0-.96.312-1.797.935-2.51C1.558.686 2.37.329 3.373.329c1.002 0 1.815.33 2.438.988.623.658.92 1.453.894 2.386zM0 30.857h6.705V8.805H0v22.052zM22.756 9.134c-.867 0-1.64.11-2.317.329a7.527 7.527 0 0 0-1.828.864 7.118 7.118 0 0 0-1.341 1.11 7.205 7.205 0 0 0-.853 1.112h-.163l-.366-2.88H9.874c0 .932.027 1.947.082 3.044.054 1.097.08 2.277.08 3.538v14.606h6.706V18.802c0-.329.013-.63.04-.905.027-.274.068-.535.122-.782.108-.301.257-.617.447-.946.19-.329.406-.617.65-.864s.542-.466.894-.658a2.13 2.13 0 0 1 1.179-.247c1.192 0 2.058.439 2.6 1.317.542.877.8 2.016.772 3.414v11.726h6.705V18.31c0-1.564-.19-2.922-.569-4.074-.379-1.152-.894-2.112-1.544-2.88a5.78 5.78 0 0 0-2.357-1.686 8.033 8.033 0 0 0-2.925-.535z" fill="#FFF" fill-rule="nonzero"/></svg>
            <span>LinkedIn</span>
          </a>
        </li>

        <li>
          <a rel="noopener noreferrer" target="_blank" href="https://medium.com/@marcellop">
            <svg aria-hidden="true" width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M16.002.384C7.16.381 0 7.538 0 16.372c0 6.985 4.48 12.924 10.718 15.104.84.211.711-.386.711-.793v-2.771c-4.851.568-5.048-2.642-5.373-3.178-.658-1.123-2.213-1.409-1.748-1.945 1.105-.568 2.23.143 3.536 2.07.943 1.398 2.785 1.162 3.718.93a4.51 4.51 0 0 1 1.24-2.174C7.776 22.714 5.681 19.647 5.681 16c0-1.77.582-3.396 1.726-4.708-.729-2.163.068-4.015.176-4.29 2.077-.186 4.236 1.487 4.404 1.62 1.18-.319 2.528-.487 4.036-.487 1.516 0 2.867.175 4.058.497.404-.308 2.406-1.745 4.336-1.57.104.276.883 2.085.197 4.219 1.158 1.316 1.748 2.957 1.748 4.73 0 3.653-2.11 6.724-7.15 7.611a4.558 4.558 0 0 1 1.362 3.253v4.022c.029.322 0 .64.536.64C27.442 29.403 32 23.422 32 16.375 32 7.538 24.836.385 16.002.385z" fill="#FFF" fill-rule="nonzero"/></svg>
            <span>Medium</span>
          </a>
        </li>
      </ul>
