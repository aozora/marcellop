...
export default function Footer() {
  return (
    <footer className="footer">
      ...
      <p className="footer__copyright">&copy; 2010–2020 Copyright Marcello Palmitessa. All rights reserved.</p>
