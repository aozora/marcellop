<template>
  <section id="contact" class="contact-area">
    ...
    <p class="contact-area__social-links">
      <a rel="noopener noreferrer" target="_blank" href="http://www.twitter.com/marcellopalmit">
        <svg width="24px" height="20px" viewBox="0 0 24 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g fill-rule="nonzero" fill="#414141">
              <g>
    ...
    <video autoplay="autoplay" loop="loop" class="lazyload">
      <title></title>
      <source src="/assets/video/garbage-trash-can-cat.mp4" type="video/mp4" />
    </video>
